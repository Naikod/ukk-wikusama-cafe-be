...
app.get(`/nota/transaksi/:id_transaksi`, authorization(["admin", "kasir"]), transaksiController.createNota)

app.get(`/transaksi/tanggal/:tanggal`, authorization(["admin", "manajer"]), transaksiController.getTransaksiByDate)
